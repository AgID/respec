...
// Module agid/style
// Inserts a link to the appropriate AGID style for the specification's maturity level.
// CONFIGURATION
...
function createResourceHints() {
  ...
  const opts = [
    ...
    },
    {
      ...
      href: "https://agid.github.io/respec-style/logos/agid.png",
      as: "image",
    },
  ];
...
//  const finalStyleURL = `https://www.w3.org/StyleSheets/TR/${finalVersionPath}${styleFile}`;
  const finalStyleURL = `https://agid.github.io/respec-style/${styleFile}`;
