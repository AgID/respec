...
//  - logos: a list of logos to use instead of the AgID logo, each of which being defined by:
...
//  - additionalCopyrightHolders: a copyright owner in addition to AgID (or the only one if specStatus
//      is unofficial)
...
export const name = "agid/headers";
...
//  PR: "Proposed Recommendation",
  PR: "Bozza finale per consultazione",
...
//      }-${concatDate(conf.previousPublishDate)}/`;
  ...
  conf.prependAGID = !conf.isUnofficial;
